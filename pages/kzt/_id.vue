    ...
    <div class="digital-container banxin">
      ...
      <div class="introduce" v-if="$route.params.id == 2">
        <dl class="common-dl">
          ...
          <dd>
            <h6>“管理会计”文章订阅</h6>
            <p>
              管理会计是企业的战略、业务、财务一体化最有效的工具，在企业数字化转型的大背景下，管理会计又承担起新的使命。MAS
              管理会计从管理会计的基础价值、管理会计的变革与创新、管理会计如何支持企业的数字化转型多方面阐述新时代下的管理会计。
            </p>
            <div class="introduce-base">
              <div class="left">
                ￥<span class="price">68</span><span class="yue">/月</span>
      ...
      <div class="main-container">
        ...
        <div class="container-two">
          <div class="two-content">
            ...
            <ul class="audio-ul">
              <li v-for="(item, index) in menuData" :key="index">
                <div class="li-left" @click="audioPlay(index, item)">
                  <img src="/images/sub-advert06.png" alt="" />
                  <img
          ...
          <div
            class="audio-box"
            :style="{ opacity: showPlay || isAudio ? '1' : '0' }"
          >
            <audio
              id="audioPlayer"
              ref="audio"
        ...
        <div class="module-l">
          ...
          <div class="classroom">
            <dl>
              ...
              <dd>
                <h6>第16期：数字化赋能产业互联</h6>
                <p><span class="name">喻翊翔</span>金凤科技 CIO</p>
              </dd>
            </dl>
            <dl>
              <dt>
        ...
        <div class="module-r">
          ...
          <ul class="module-r-ul">
            ...
            <li @click="zffDetails(2)">
              ...
              <div class="base">
                <div class="left">
                  <img src="/images/time.png" alt="" class="icon" />
                  <span>2022-03-14</span>
...
.digital-container {
  ...
  .main-container {
    ...
    .container-two {
      width: 346px;
      height: 462px;
      background: linear-gradient(245deg, #e9ebf1 0%, #f6f7f9 23%, #ffffff 95%);
      border-radius: 6px;
